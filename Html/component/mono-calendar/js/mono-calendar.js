(function (global, factory) {
    ...
    MonoCalendar.prototype = {
        ...
        initBtsDom: function () {
            var _this = this;
            var now = document.createElement('button'); //此刻
        ...
        renderYearDom: function () {
            ...
            var prevYear = document.createElement('button'); //上一年
            ...
            var prevmonth = document.createElement('button'); //上一月
    ...
    MonoCalendar.prototype.constructor = MonoCalendar;
    if (typeof noGlobal === 'undefined') {
        window.MonoCalendar = MonoCalendar;
    }
    return MonoCalendar;
});
