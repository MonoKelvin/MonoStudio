<template>
  <div class="app-shell app-theme">
    <GlobalTooltip />
    <TitleBar :is-maximized="isMaximized" :is-pinned="isPinned" @minimize="minimizeWindow" @toggle-maximize="toggleMaximizeWindow" @toggle-pin="togglePinWindow" @close="closeWindow" />
    <div class="workspace shell-grid" :class="{ 'is-resizing': isResizingSidebar }" :style="shellGridStyle">
      <SidebarNav
          ...
          :personal-life-gate="personalLifeGate"
          :personal-life-unlocked="personalLifeUnlocked"
      ...
      <ToolWorkspace
        ...
        :open-dev-tools="settings.openDevTools"
        @change-theme="setThemeAndSave"
        @change-accent-color="setAccentColorAndSave"
        @change-dev-tools="setDevToolsAndSave"
        @unlock-personal-life="unlockPersonalLife"
        @lock-personal-life="lockPersonalLife"
      />
    </div>
    <div
