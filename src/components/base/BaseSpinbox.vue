<template>
  <div class="ui-spinbox" @wheel.prevent="onWheel">
    ...
    <div class="ui-spinbox-arrows">
      <div class="ui-spinbox-btn-up" @click="increment">
        <svg width="10" height="6" viewBox="0 0 10 6">
          <path d="M1 5L5 1L9 5" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </div>
      <div class="ui-spinbox-btn-down" @click="decrement">
        <svg width="10" height="6" viewBox="0 0 10 6">
